...
-- CreateIndex
CREATE INDEX "DeviceAuthCode_code_idx" ON "DeviceAuthCode"("code");
...
-- AddForeignKey
ALTER TABLE "DeviceAuthCode" ADD CONSTRAINT "DeviceAuthCode_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE SET NULL ON UPDATE CASCADE;
